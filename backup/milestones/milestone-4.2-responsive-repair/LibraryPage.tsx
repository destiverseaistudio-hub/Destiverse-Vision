    ...
    <main className="space-y-8 pb-4">
      ...
      {continueWatching.length > 0 ? (
        <section>
          ...
          <div className="flex gap-3 overflow-x-auto pb-3 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:gap-4">{continueWatching.map(({ item, progress: entry }) => <div className="min-w-[220px]" key={item!.id}><Link to={`/dashboard/content/${item!.id}?play=1`} className="block">
