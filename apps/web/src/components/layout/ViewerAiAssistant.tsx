...
export default function ViewerAiAssistant() {
  ...
  return <div className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] right-4 z-[70] lg:bottom-6 lg:right-6">
    {open ? <section aria-label="Vision Guide AI helper" className="mb-3 flex h-[min(34rem,calc(100dvh-8rem))] w-[min(23rem,calc(100vw-2rem))] flex-col overflow-hidden rounded-3xl border border-white/15 bg-[#12111a] shadow-2xl shadow-black/60">
